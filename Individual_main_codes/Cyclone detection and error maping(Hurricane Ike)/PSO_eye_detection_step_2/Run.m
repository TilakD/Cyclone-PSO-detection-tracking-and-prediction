...
M = 4;
K = zeros(36, 1, 'uint32');
color_img_pathname = 'E:\Image Processing\Cyclone detection\new_cropped_db_code\output\';
initial_frame_number = 1;
final_frame_number = 36;
for i = initial_frame_number : final_frame_number
    c = imread(strcat(color_img_pathname,'1 (', num2str(i),')','.jpg'));
display(i);
%c=imread('1 (1).jpg');
%--------------------------------------------
